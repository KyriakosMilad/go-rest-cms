...
type User struct {
	...
	FirstName string    `json:"firstName" db_column_name:"first_name" db_column_specs:"VARCHAR(10) NOT NULL"`
	LastName  string    `json:"lastName" db_column_name:"last_name" db_column_specs:"VARCHAR(10) NOT NULL"`
	...
	CreatedAt time.Time `json:"createdAt" db_column_name:"created_at" db_column_specs:"TIMESTAMP NOT NULL"`
	UpdatedAt time.Time `json:"updatedAt" db_column_name:"updated_at" db_column_specs:"TIMESTAMP NOT NULL"`
	DeletedAt time.Time `json:"deletedAt" db_column_name:"deleted_at" db_column_specs:"TIMESTAMP"`
}
